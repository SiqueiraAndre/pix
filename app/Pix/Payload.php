...
class Payload
{
    ...
    private function getMerchantAccountInformation()
    {
        ...
        //DESCRIÇÃO DO PAGAMENTO
        $descripton  = strlen($this->description) ? $this->getValue(self::ID_MERCHANT_ACCOUNT_INFORMATION_DESCRIPTION,$this->description) : '';

        //VALOR COMPLETO DA CONTA
        return $this->getValue(self::ID_MERCHANT_ACCOUNT_INFORMATION,$gui.$key.$descripton);
    }

    /**
     * Método responsável por retornar os valores completos erar o código completo do payload Pix
     * @return string
     */
